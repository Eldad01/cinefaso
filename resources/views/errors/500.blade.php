...
<body class="font-body min-h-screen flex items-center justify-center bg-cf-bg px-4">
    <div class="text-center">
        ...
        <h1 class="font-display text-2xl font-bold text-cf-ink">Une erreur est survenue</h1>
        <p class="mt-2 text-cf-muted">Quelque chose s'est mal passé de notre côté. Merci de réessayer dans un instant.</p>
