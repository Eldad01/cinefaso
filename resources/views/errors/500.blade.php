...
<body class="min-h-screen flex items-center justify-center bg-gray-50 px-4">
    <div class="text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Une erreur est survenue</h1>
        <p class="mt-2 text-gray-500">Quelque chose s'est mal passé de notre côté. Merci de réessayer dans un instant.</p>
