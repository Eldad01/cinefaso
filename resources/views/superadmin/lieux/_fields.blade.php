...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
    ...
    <div>
        <label for="tarifs" class="block text-sm font-medium text-gray-700 mb-1">Tarifs</label>
...
<div class="mt-4">
    ...
    <textarea name="description" id="description" rows="3"
              class="w-full rounded-lg border-gray-300 text-sm focus:border-primary-500 focus:ring-primary-500">{{ old('description', $lieu?->description) }}</textarea>
</div>

<div class="mt-4">
    <label for="festival_id" class="block text-sm font-medium text-gray-700 mb-1">Festival associé <span class="text-gray-400">(pour un lieu temporaire)</span></label>
    <select name="festival_id" id="festival_id" class="w-full rounded-lg border-gray-300 text-sm focus:border-primary-500 focus:ring-primary-500">
...
<div class="mt-4 flex items-center gap-2">
    ...
    <label for="partenaire" class="text-sm text-gray-700">Lieu partenaire</label>
</div>
